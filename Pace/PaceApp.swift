...
struct PaceApp: App {
    ...
    init() {
        if ProcessInfo.processInfo.environment["PACE_CRASH_ON_APPKIT_EXCEPTIONS"] == "1" {
...
class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    private static let mainWindowIdentifier = NSUserInterfaceItemIdentifier("pace.mainWindow")
